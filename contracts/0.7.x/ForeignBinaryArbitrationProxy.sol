...
contract ForeignBinaryArbitrationProxy is IForeignBinaryArbitrationProxy, IEvidence {
     ...
     * @param _homeDisputeID The ID of the dispute on the home arbitrator.
     * @param _numberOfJurors The address of the arbitrable contract.
     */
    function requestDispute(uint256 _homeDisputeID, uint256 _numberOfJurors) external payable onlyIfInitialized {
        ...
        bytes memory data =
            abi.encodeWithSelector(methodSelector, arbitration.arbitrable, _homeDisputeID, msg.sender);
